const allBlogs = [
  {
    "title": "Agile Transformation Is a People Problem Wearing a Process Costume",
    "date": "2025-12-05",
    "summary": "Lessons from leading Agile transformation at a fintech company: the ceremonies are the easy part.",
  ...
  },
  {
    ...
    "featured": true,
    "content": `## Three Countries, One Throughline
...
Don't wait for a "logical next step." The e-commerce years didn't look like a technology career until years later — but every one of them is still visible in how I approach product problems today.`,
    "_meta": {
      "filePath": "ohio-storefront-to-cybersecurity-research.md",
      "fileName": "ohio-storefront-to-cybersecurity-research.md",
      "directory": ".",
      "extension": "md",
      "path": "ohio-storefront-to-cybersecurity-research"
    }
  },
  {
  ...
  },
  {
    ...
    "readingTime": "5 min read",
    "featured": false,
    "content": `如果第一部分是前端和后端为了一个下拉框互相开战，那第二部分就是整个团队团结一致 - 一起跟项目经理吵架。\r
...
Credit: Code toàn bug`,
    "_meta": {
      "filePath": "只是加个下拉菜单而已.md",
      "fileName": "只是加个下拉菜单而已.md",
      "directory": ".",
      "extension": "md",
      "path": "只是加个下拉菜单而已"
    }
